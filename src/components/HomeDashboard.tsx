        ...
        <div className="flex min-h-[1000px] w-full flex-col items-center justify-between pb-10 pt-16 text-center md:min-h-[800px] backdrop-blur-none bg-black/30">
          <div className="flex flex-col items-center">
            <h1 className="text-6xl font-bold text-[white]">
              ACCIDENT INJURY INJUSTICE
            </h1>
            <p className="pt-3 text-2xl font-bold text-[white]">
            Referral Portal for Accident Injustice
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            Guiding You from Injury to Resolution. Speak with a Top Law Firm
            </h2>
          </div>
          <div className="flex flex-col">
            <div className="mt-4 flex flex-col gap-5 rounded-[6px] bg-transparent xl:h-[245px] xl:w-[940px]">
              ...
              <div className="grid w-full grid-cols-3 mx-auto md:grid-cols-6">
          ...
          <div className="px-5 space-y-5">
            <h1 className="my-3 text-4xl font-bold text-white max-sm:text-3xl">
              Talk with a Lawyer NOW
            </h1>
            <a
              href="tel:8449843529"
              className="text-4xl font-semibold  text-[#f7901e] hover:underline"
            >
              844-984-3529
            </a>
          </div>
